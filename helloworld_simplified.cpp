...
int main(int argc, char** argv){
    ...
    trajectory_t original_traj_for_simplification = read_trajectory_from_file<space>(pathlet_file_name);
    ...
    algo.unsimplify_collected_pathlets(original_traj_for_simplification);
    //algo.compute_all_frequent_pathlets();
